...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.cclafferty.keyboardViewSetter.js')
	...
	f = os.path.join(cwd,'Classes','ComCclaffertyKeyboardViewSetterModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.cclafferty.keyboardViewSetter.js']
